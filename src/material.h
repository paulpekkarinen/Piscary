...
#define MAT_FABRIC      24 /* for cloths and some special items */
...
struct matlist
{
	...
	int Get_Value(); //how valuable this material is
	bool Is_Suitable_For(item_def *i);
	void Apply_Item_Mods(item_def *i);
};
